                         ...
                         genom_context ctx)
{
  ...
  genom_take_resource(
    self,
    self->resources.task_move ||
    self->resources.task_batt ||
    self->resources.all,
  ...
  /* find the inport */
  if (!strcmp(local, "JS")) {
    s = genom_loco_JS_connect(remote, ctx);
    goto done;
  }
  if (!strcmp(local, "AR")) {
    s = genom_loco_AR_connect(remote, ctx);
    goto done;
  }
  if (!strcmp(local, "POS")) {
    s = genom_loco_POS_connect(remote, ctx);
    goto done;
  }
...
genom_event
genom_loco_abort_activity_controlcb(
...
genom_event
genom_loco_connect_port_controlcb(
  struct genom_component_data *self,
...
genom_event
genom_loco_connect_service_controlcb(
  struct genom_component_data *self,
...
genom_event
genom_loco_GetCurrentPosition_controlcb(
  struct genom_component_data *self,
  struct genom_loco_GetCurrentPosition_activity *a)
{
  ...
  genom_take_resource(
    ...
    self->resources.control = genom_loco_GetCurrentPosition_controlcb);
...
genom_event
genom_loco_GetCurrentBattery_controlcb(
  struct genom_component_data *self,
...
genom_event
genom_loco_GetCurrentMap_controlcb(
  struct genom_component_data *self,
  struct genom_loco_GetCurrentMap_activity *a)
{
  ...
  genom_take_resource(
    ...
    self->resources.control = genom_loco_GetCurrentMap_controlcb);
...
genom_event
genom_loco_GetCurrentArena_controlcb(
  struct genom_component_data *self,
  struct genom_loco_GetCurrentArena_activity *a)
{
  ...
  genom_take_resource(
    ...
    self->resources.control = genom_loco_GetCurrentArena_controlcb);
...
/* --- Service MoveStop control codels ---------------------------------- */

genom_event
genom_loco_MoveStop_controlcb(
  struct genom_component_data *self,
...
/* --- Service BattStop control codels ---------------------------------- */

genom_event
genom_loco_BattStop_controlcb(
  struct genom_component_data *self,
...
/* --- Service StartMove control codels --------------------------------- */

genom_event
genom_loco_StartMove_controlcb(
  struct genom_component_data *self,
...
/* --- Service StartBatt control codels --------------------------------- */

genom_event
genom_loco_StartBatt_controlcb(
  struct genom_component_data *self,
