...
static __inline__ size_t	genom_maxserialen_port(void);
static __inline__ size_t	genom_serialen_port(
					const loco_BAT *);
static __inline__ void		genom_serialize_port(char **,
					const loco_BAT *);
static __inline__ int		genom_deserialize_port(char **,
					ssize_t *, loco_BAT *);
...
static __inline__ size_t	genom_maxserialen_t_loco_dir_moteur_enum(void);
static __inline__ size_t	genom_serialen_t_loco_dir_moteur_enum(
					loco_dir_moteur_enum);
static __inline__ void		genom_serialize_t_loco_dir_moteur_enum(char **,
					loco_dir_moteur_enum);
static __inline__ int		genom_deserialize_t_loco_dir_moteur_enum(char **,
					ssize_t *, loco_dir_moteur_enum *);
static __inline__ size_t	genom_maxserialen_t_loco_direction_moteur(void);
static __inline__ size_t	genom_serialen_t_loco_direction_moteur(
					const loco_direction_moteur *);
static __inline__ void		genom_serialize_t_loco_direction_moteur(char **,
					const loco_direction_moteur *);
static __inline__ int		genom_deserialize_t_loco_direction_moteur(char **,
					ssize_t *, loco_direction_moteur *);
static __inline__ size_t	genom_maxserialen_t_loco_motor(void);
static __inline__ size_t	genom_serialen_t_loco_motor(
					const loco_motor *);
static __inline__ void		genom_serialize_t_loco_motor(char **,
					const loco_motor *);
static __inline__ int		genom_deserialize_t_loco_motor(char **,
					ssize_t *, loco_motor *);
static __inline__ size_t	genom_maxserialen_t_loco_ids(void);
static __inline__ size_t	genom_serialen_t_loco_ids(
					const loco_ids *);
static __inline__ void		genom_serialize_t_loco_ids(char **,
					const loco_ids *);
static __inline__ int		genom_deserialize_t_loco_ids(char **,
					ssize_t *, loco_ids *);
...
static __inline__ size_t
genom_maxserialen_port(void)
{
  return sizeof(loco_BAT);
}

static __inline__ size_t
genom_serialen_port(const loco_BAT *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_port(char **buffer, const loco_BAT *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
static __inline__ int
genom_deserialize_port(char **buffer, ssize_t *size,
  loco_BAT *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
...
static __inline__ size_t
genom_maxserialen_t_loco_dir_moteur_enum(void)
{
  return sizeof(loco_dir_moteur_enum);
}

static __inline__ size_t
genom_serialen_t_loco_dir_moteur_enum(loco_dir_moteur_enum data)
{
  return sizeof(data);
}

static __inline__ void
genom_serialize_t_loco_dir_moteur_enum(char **buffer, loco_dir_moteur_enum data)
{
  memcpy(*buffer, &(data),
         sizeof(data));
  *buffer += sizeof(data);
...
static __inline__ int
genom_deserialize_t_loco_dir_moteur_enum(char **buffer, ssize_t *size,
  loco_dir_moteur_enum *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
    if (*size < 0) return ENOMSG;
...
static __inline__ size_t
genom_maxserialen_t_loco_direction_moteur(void)
{
  return sizeof(loco_direction_moteur);
}

static __inline__ size_t
genom_serialen_t_loco_direction_moteur(const loco_direction_moteur *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_t_loco_direction_moteur(char **buffer, const loco_direction_moteur *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
static __inline__ int
genom_deserialize_t_loco_direction_moteur(char **buffer, ssize_t *size,
  loco_direction_moteur *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
    if (*size < 0) return ENOMSG;
...
static __inline__ size_t
genom_maxserialen_t_loco_motor(void)
{
  return sizeof(loco_motor);
}

static __inline__ size_t
genom_serialen_t_loco_motor(const loco_motor *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_t_loco_motor(char **buffer, const loco_motor *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
static __inline__ int
genom_deserialize_t_loco_motor(char **buffer, ssize_t *size,
  loco_motor *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
...
static __inline__ size_t
genom_maxserialen_t_loco_ids(void)
{
  return sizeof(loco_ids);
}

static __inline__ size_t
genom_serialen_t_loco_ids(const loco_ids *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_t_loco_ids(char **buffer, const loco_ids *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
static __inline__ int
genom_deserialize_t_loco_ids(char **buffer, ssize_t *size,
  loco_ids *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
