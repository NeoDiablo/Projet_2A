...
int
genom_display_client_abort_activity_json_scan(
  struct genom_display_abort_activity_input *in, const char *json,
  char **endptr)
{
  int s = 0;
...
int
genom_display_client_abort_activity_json_print(char **json,
             const struct genom_display_abort_activity_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_connect_port_json_scan(
  struct genom_display_connect_port_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  json_skip_whitespace(json);
...
int
genom_display_client_connect_port_json_print(char **json,
             const struct genom_display_connect_port_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_connect_service_json_scan(
  struct genom_display_connect_service_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  json_skip_whitespace(json);
...
int
genom_display_client_connect_service_json_print(char **json,
             const struct genom_display_connect_service_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_kill_json_scan(
  struct genom_display_kill_input *in, const char *json,
  char **endptr)
{
  int s = 0;
...
int
genom_display_client_kill_json_print(char **json,
             const struct genom_display_kill_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_GetCurrentPosition_json_scan(
  struct genom_display_GetCurrentPosition_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_GetCurrentPosition_json_print(char **json,
             const struct genom_display_GetCurrentPosition_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_GetCurrentBattery_json_scan(
  struct genom_display_GetCurrentBattery_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_GetCurrentBattery_json_print(char **json,
             const struct genom_display_GetCurrentBattery_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_GetCurrentMap_json_scan(
  struct genom_display_GetCurrentMap_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_GetCurrentMap_json_print(char **json,
             const struct genom_display_GetCurrentMap_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_GetCurrentArena_json_scan(
  struct genom_display_GetCurrentArena_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_GetCurrentArena_json_print(char **json,
             const struct genom_display_GetCurrentArena_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_SendOrdersStop_json_scan(
  struct genom_display_SendOrdersStop_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_SendOrdersStop_json_print(char **json,
             const struct genom_display_SendOrdersStop_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_MonitoringStop_json_scan(
  struct genom_display_MonitoringStop_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_MonitoringStop_json_print(char **json,
             const struct genom_display_MonitoringStop_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_SendOrders_json_scan(
  struct genom_display_SendOrders_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_SendOrders_json_print(char **json,
             const struct genom_display_SendOrders_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_Monitoring_json_scan(
  struct genom_display_Monitoring_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_display_client_Monitoring_json_print(char **json,
             const struct genom_display_Monitoring_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_display_client_genom_state_json_print(char **json,
...
int
genom_display_client_JS_json_print(char **json,
  const display_order *data)
{
  ...
  *json = end = malloc(len);
  ...
  if ((s = bufcat(json, &end, &len, 0, "\"JS\":")))
    goto done;
  if ((s = json_print_t_display_order(json, &end, &len, data)))
    goto done;
...
char *
genom_display_client_json_error(genom_client h,
                         genom_event e, const void *detail)
{
  ...
  else if (e == display_INVALID_ORDER_id) {
    if (bufcat(&s, &end, &len, 0, "{\"ex\":\"")) return NULL;
    if (bufcat(&s, &end, &len, 0, display_INVALID_ORDER_id)) return NULL;
    if (bufcat(&s, &end, &len, 0, "\"}")) return NULL;
    return s;
  }
  else if (e == display_INVALID_DATA_id) {
    if (bufcat(&s, &end, &len, 0, "{\"ex\":\"")) return NULL;
    if (bufcat(&s, &end, &len, 0, display_INVALID_DATA_id)) return NULL;
    if (bufcat(&s, &end, &len, 0, "\"}")) return NULL;
    return s;
  }
