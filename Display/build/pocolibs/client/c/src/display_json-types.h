...
static __inline__ int	json_scan_t_display_INVALID_ORDER(
  display_INVALID_ORDER_detail *, const char **);
static __inline__ int	json_print_t_display_INVALID_ORDER(char **, char **, size_t *,
  const display_INVALID_ORDER_detail *);
static __inline__ int	json_scan_t_display_INVALID_DATA(
  display_INVALID_DATA_detail *, const char **);
static __inline__ int	json_print_t_display_INVALID_DATA(char **, char **, size_t *,
...
static __inline__ int
json_scan_t_display_INVALID_ORDER(display_INVALID_ORDER_detail *data, const char **json)
{
  int s = 0;
  (void)data; /* fix -Wunused-parameter */
  json_skip_whitespace(*json);
...
static __inline__ int
json_print_t_display_INVALID_ORDER(char **json, char **end, size_t *len,
  const display_INVALID_ORDER_detail *data)
{
  int s;
  (void)data; /* fix -Wunused-parameter */
  if ((s = bufcat(json, end, len, 0, "{"))) return s;
...
static __inline__ int
json_scan_t_display_INVALID_DATA(display_INVALID_DATA_detail *data, const char **json)
{
  int s = 0;
  (void)data; /* fix -Wunused-parameter */
  json_skip_whitespace(*json);
...
static __inline__ int
json_print_t_display_INVALID_DATA(char **json, char **end, size_t *len,
  const display_INVALID_DATA_detail *data)
{
  int s;
  (void)data; /* fix -Wunused-parameter */
  if ((s = bufcat(json, end, len, 0, "{"))) return s;
