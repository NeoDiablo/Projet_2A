...
static __inline__ void	genom_tinit_t_display_INVALID_ORDER(
				display_INVALID_ORDER_detail *);
static __inline__ void	genom_tfini_t_display_INVALID_ORDER(
				display_INVALID_ORDER_detail *);
static __inline__ int	genom_tcopy_t_display_INVALID_ORDER(
				display_INVALID_ORDER_detail *,
				const display_INVALID_ORDER_detail *);
static __inline__ void	genom_tinit_t_display_INVALID_DATA(
				display_INVALID_DATA_detail *);
static __inline__ void	genom_tfini_t_display_INVALID_DATA(
				display_INVALID_DATA_detail *);
static __inline__ int	genom_tcopy_t_display_INVALID_DATA(
				display_INVALID_DATA_detail *,
				const display_INVALID_DATA_detail *);
static __inline__ void	genom_tinit_t_display_ids(
				display_ids *);
static __inline__ void	genom_tfini_t_display_ids(
				display_ids *);
static __inline__ int	genom_tcopy_t_display_ids(
				display_ids *,
				const display_ids *);
...
static __inline__ void
genom_tinit_port(display_BAT *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ void
genom_tfini_port(display_BAT *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_tcopy_port(display_BAT *dst,
  const display_BAT *src)
{
  memcpy(dst, src, sizeof(display_BAT));
  return 0;
}
...
static __inline__ void
genom_tinit_t_display_INVALID_ORDER(display_INVALID_ORDER_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ void
genom_tfini_t_display_INVALID_ORDER(display_INVALID_ORDER_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_tcopy_t_display_INVALID_ORDER(display_INVALID_ORDER_detail *dst,
  const display_INVALID_ORDER_detail *src)
{
  (void)dst; (void)src; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ void
genom_tinit_t_display_INVALID_DATA(display_INVALID_DATA_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ void
genom_tfini_t_display_INVALID_DATA(display_INVALID_DATA_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_tcopy_t_display_INVALID_DATA(display_INVALID_DATA_detail *dst,
  const display_INVALID_DATA_detail *src)
{
  (void)dst; (void)src; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ void
genom_tinit_t_display_ids(display_ids *data)
{
  genom_tinit_t_display_order(&(data->command));
  genom_tinit_long(&(data->key));
...
static __inline__ void
genom_tfini_t_display_ids(display_ids *data)
{
  genom_tfini_t_display_order(&(data->command));
  genom_tfini_long(&(data->key));
...
static __inline__ int
genom_tcopy_t_display_ids(display_ids *dst,
  const display_ids *src)
{
  memcpy(dst, src, sizeof(display_ids));
  return 0;
}
