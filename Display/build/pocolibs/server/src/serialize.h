...
static __inline__ size_t	genom_maxserialen_t_display_INVALID_ORDER(void);
static __inline__ size_t	genom_serialen_t_display_INVALID_ORDER(
					const display_INVALID_ORDER_detail *);
static __inline__ void		genom_serialize_t_display_INVALID_ORDER(char **,
					const display_INVALID_ORDER_detail *);
static __inline__ int		genom_deserialize_t_display_INVALID_ORDER(char **,
					ssize_t *, display_INVALID_ORDER_detail *);
static __inline__ size_t	genom_maxserialen_t_display_INVALID_DATA(void);
static __inline__ size_t	genom_serialen_t_display_INVALID_DATA(
					const display_INVALID_DATA_detail *);
static __inline__ void		genom_serialize_t_display_INVALID_DATA(char **,
					const display_INVALID_DATA_detail *);
static __inline__ int		genom_deserialize_t_display_INVALID_DATA(char **,
					ssize_t *, display_INVALID_DATA_detail *);
static __inline__ size_t	genom_maxserialen_t_display_ids(void);
static __inline__ size_t	genom_serialen_t_display_ids(
					const display_ids *);
static __inline__ void		genom_serialize_t_display_ids(char **,
					const display_ids *);
static __inline__ int		genom_deserialize_t_display_ids(char **,
					ssize_t *, display_ids *);
...
genom_maxserialen_sequence_t_genom_state_activity(void)
{
  ...
  extern size_t display_varmsg_maxsize;
  return display_varmsg_maxsize;
}
...
{
  return sizeof(display_BAT);
}

static __inline__ size_t
genom_serialen_port(const display_BAT *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_port(char **buffer, const display_BAT *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
/* === t_display_INVALID_ORDER ========================================== */

static __inline__ size_t
genom_maxserialen_t_display_INVALID_ORDER(void)
{
  return 0;
}

static __inline__ size_t
genom_serialen_t_display_INVALID_ORDER(const display_INVALID_ORDER_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ void
genom_serialize_t_display_INVALID_ORDER(char **buffer, const display_INVALID_ORDER_detail *data)
{
  (void)buffer; (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_deserialize_t_display_INVALID_ORDER(char **buffer, ssize_t *size,
  display_INVALID_ORDER_detail *data)
{
  (void)buffer; (void)size; (void)data; /* fix -Wunused-parameter */
  return 0;
}

/* === t_display_INVALID_DATA =========================================== */

static __inline__ size_t
genom_maxserialen_t_display_INVALID_DATA(void)
{
  return 0;
}

static __inline__ size_t
genom_serialen_t_display_INVALID_DATA(const display_INVALID_DATA_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ void
genom_serialize_t_display_INVALID_DATA(char **buffer, const display_INVALID_DATA_detail *data)
{
  (void)buffer; (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_deserialize_t_display_INVALID_DATA(char **buffer, ssize_t *size,
  display_INVALID_DATA_detail *data)
{
  (void)buffer; (void)size; (void)data; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ size_t
genom_maxserialen_t_display_ids(void)
{
  return sizeof(display_ids);
}

static __inline__ size_t
genom_serialen_t_display_ids(const display_ids *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_t_display_ids(char **buffer, const display_ids *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
static __inline__ int
genom_deserialize_t_display_ids(char **buffer, ssize_t *size,
  display_ids *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
