...
static __inline__ void	genom_tinit_t_camera_INVALID_DATA(
				camera_INVALID_DATA_detail *);
static __inline__ void	genom_tfini_t_camera_INVALID_DATA(
				camera_INVALID_DATA_detail *);
static __inline__ int	genom_tcopy_t_camera_INVALID_DATA(
				camera_INVALID_DATA_detail *,
				const camera_INVALID_DATA_detail *);
static __inline__ void	genom_tinit_t_camera_ids(
				camera_ids *);
static __inline__ void	genom_tfini_t_camera_ids(
				camera_ids *);
static __inline__ int	genom_tcopy_t_camera_ids(
				camera_ids *,
				const camera_ids *);
...
static __inline__ void
genom_tinit_port(camera_IM *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ void
genom_tfini_port(camera_IM *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_tcopy_port(camera_IM *dst,
  const camera_IM *src)
{
  memcpy(dst, src, sizeof(camera_IM));
  return 0;
}
...
static __inline__ void
genom_tinit_t_camera_INVALID_DATA(camera_INVALID_DATA_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ void
genom_tfini_t_camera_INVALID_DATA(camera_INVALID_DATA_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_tcopy_t_camera_INVALID_DATA(camera_INVALID_DATA_detail *dst,
  const camera_INVALID_DATA_detail *src)
{
  (void)dst; (void)src; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ void
genom_tinit_t_camera_ids(camera_ids *data)
{
...
static __inline__ void
genom_tfini_t_camera_ids(camera_ids *data)
{
...
static __inline__ int
genom_tcopy_t_camera_ids(camera_ids *dst,
  const camera_ids *src)
{
  memcpy(dst, src, sizeof(camera_ids));
  return 0;
}
