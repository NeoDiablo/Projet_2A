...
static __inline__ size_t	genom_maxserialen_t_camera_INVALID_DATA(void);
static __inline__ size_t	genom_serialen_t_camera_INVALID_DATA(
					const camera_INVALID_DATA_detail *);
static __inline__ void		genom_serialize_t_camera_INVALID_DATA(char **,
					const camera_INVALID_DATA_detail *);
static __inline__ int		genom_deserialize_t_camera_INVALID_DATA(char **,
					ssize_t *, camera_INVALID_DATA_detail *);
static __inline__ size_t	genom_maxserialen_t_camera_ids(void);
static __inline__ size_t	genom_serialen_t_camera_ids(
					const camera_ids *);
static __inline__ void		genom_serialize_t_camera_ids(char **,
					const camera_ids *);
static __inline__ int		genom_deserialize_t_camera_ids(char **,
					ssize_t *, camera_ids *);
...
genom_maxserialen_sequence_t_genom_state_activity(void)
{
  ...
  extern size_t camera_varmsg_maxsize;
  return camera_varmsg_maxsize;
}
...
{
  return sizeof(camera_IM);
}

static __inline__ size_t
genom_serialen_port(const camera_IM *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_port(char **buffer, const camera_IM *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
/* === t_camera_INVALID_DATA ============================================ */

static __inline__ size_t
genom_maxserialen_t_camera_INVALID_DATA(void)
{
  return 0;
}

static __inline__ size_t
genom_serialen_t_camera_INVALID_DATA(const camera_INVALID_DATA_detail *data)
{
  (void)data; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ void
genom_serialize_t_camera_INVALID_DATA(char **buffer, const camera_INVALID_DATA_detail *data)
{
  (void)buffer; (void)data; /* fix -Wunused-parameter */
}

static __inline__ int
genom_deserialize_t_camera_INVALID_DATA(char **buffer, ssize_t *size,
  camera_INVALID_DATA_detail *data)
{
  (void)buffer; (void)size; (void)data; /* fix -Wunused-parameter */
  return 0;
}
...
static __inline__ size_t
genom_maxserialen_t_camera_ids(void)
{
  return sizeof(camera_ids);
}

static __inline__ size_t
genom_serialen_t_camera_ids(const camera_ids *data)
{
  return sizeof(*(data));
}

static __inline__ void
genom_serialize_t_camera_ids(char **buffer, const camera_ids *data)
{
  memcpy(*buffer, &(*(data)),
         sizeof(*(data)));
  *buffer += sizeof(*(data));
...
static __inline__ int
genom_deserialize_t_camera_ids(char **buffer, ssize_t *size,
  camera_ids *data)
{
  if (*size != -1) {
    *size -= sizeof(*(data));
