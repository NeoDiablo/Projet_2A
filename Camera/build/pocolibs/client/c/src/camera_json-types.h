...
static __inline__ int	json_scan_t_camera_INVALID_DATA(
  camera_INVALID_DATA_detail *, const char **);
static __inline__ int	json_print_t_camera_INVALID_DATA(char **, char **, size_t *,
...
static __inline__ int
json_scan_t_camera_INVALID_DATA(camera_INVALID_DATA_detail *data, const char **json)
{
  int s = 0;
  (void)data; /* fix -Wunused-parameter */
  json_skip_whitespace(*json);
...
static __inline__ int
json_print_t_camera_INVALID_DATA(char **json, char **end, size_t *len,
  const camera_INVALID_DATA_detail *data)
{
  int s;
  (void)data; /* fix -Wunused-parameter */
  if ((s = bufcat(json, end, len, 0, "{"))) return s;
