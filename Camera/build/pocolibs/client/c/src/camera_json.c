...
int
genom_camera_client_abort_activity_json_scan(
  struct genom_camera_abort_activity_input *in, const char *json,
  char **endptr)
{
  int s = 0;
...
int
genom_camera_client_abort_activity_json_print(char **json,
             const struct genom_camera_abort_activity_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_connect_port_json_scan(
  struct genom_camera_connect_port_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  json_skip_whitespace(json);
...
int
genom_camera_client_connect_port_json_print(char **json,
             const struct genom_camera_connect_port_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_connect_service_json_scan(
  struct genom_camera_connect_service_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  json_skip_whitespace(json);
...
int
genom_camera_client_connect_service_json_print(char **json,
             const struct genom_camera_connect_service_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_kill_json_scan(
  struct genom_camera_kill_input *in, const char *json,
  char **endptr)
{
  int s = 0;
...
int
genom_camera_client_kill_json_print(char **json,
             const struct genom_camera_kill_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_GetCurrentPosition_json_scan(
  struct genom_camera_GetCurrentPosition_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_camera_client_GetCurrentPosition_json_print(char **json,
             const struct genom_camera_GetCurrentPosition_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_GetCurrentMap_json_scan(
  struct genom_camera_GetCurrentMap_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_camera_client_GetCurrentMap_json_print(char **json,
             const struct genom_camera_GetCurrentMap_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_GetCurrentArena_json_scan(
  struct genom_camera_GetCurrentArena_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_camera_client_GetCurrentArena_json_print(char **json,
             const struct genom_camera_GetCurrentArena_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_FilmStop_json_scan(
  struct genom_camera_FilmStop_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_camera_client_FilmStop_json_print(char **json,
             const struct genom_camera_FilmStop_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_StartFilm_json_scan(
  struct genom_camera_StartFilm_input *in, const char *json,
  char **endptr)
{
  int s = 0;
  (void)in; /* fix -Wunused-parameter */
...
int
genom_camera_client_StartFilm_json_print(char **json,
             const struct genom_camera_StartFilm_output *out)
{
  size_t len;
  char *end;
  int s;
...
int
genom_camera_client_genom_state_json_print(char **json,
...
int
genom_camera_client_AR_json_print(char **json,
  const camera_arena *data)
{
  ...
  *json = end = malloc(len);
  ...
  if ((s = bufcat(json, &end, &len, 0, "\"AR\":")))
    goto done;
  if ((s = json_print_t_camera_arena(json, &end, &len, data)))
    goto done;
...
int
genom_camera_client_POS_json_print(char **json,
  const camera_robot *data)
{
  ...
  *json = end = malloc(len);
  ...
  if ((s = bufcat(json, &end, &len, 0, "\"POS\":")))
    goto done;
  if ((s = json_print_t_camera_robot(json, &end, &len, data)))
    goto done;
...
int
genom_camera_client_IM_json_print(char **json,
  const camera_map *data)
{
  ...
  *json = end = malloc(len);
  ...
  if ((s = bufcat(json, &end, &len, 0, "\"IM\":")))
    goto done;
  if ((s = json_print_t_camera_map(json, &end, &len, data)))
    goto done;
...
char *
genom_camera_client_json_error(genom_client h,
                         genom_event e, const void *detail)
{
  ...
  else if (e == camera_INVALID_DATA_id) {
    if (bufcat(&s, &end, &len, 0, "{\"ex\":\"")) return NULL;
    if (bufcat(&s, &end, &len, 0, camera_INVALID_DATA_id)) return NULL;
    if (bufcat(&s, &end, &len, 0, "\"}")) return NULL;
    return s;
  }
