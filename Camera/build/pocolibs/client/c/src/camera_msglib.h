...
#ifndef H_CAMERA_MSGLIB
#define H_CAMERA_MSGLIB
...
enum {
  CAMERA_abort_activity_RQSTID,
  CAMERA_connect_port_RQSTID,
  CAMERA_connect_service_RQSTID,
  CAMERA_kill_RQSTID,
  CAMERA_GetCurrentPosition_RQSTID,
  CAMERA_GetCurrentMap_RQSTID,
  CAMERA_GetCurrentArena_RQSTID,
  CAMERA_FilmStop_RQSTID,
  CAMERA_StartFilm_RQSTID,
...
genom_camera_max_rqst_size(void)
{
  size_t m = 0, s;
...
#define  CAMERA_MAX_RQST_SIZE	genom_camera_max_rqst_size()

/* Size of reception mailbox */
#define  CAMERA_MBOX_RQST_SIZE                                \
  (MBOX_BUF_SIZE(CAMERA_MAX_RQST_SIZE) * SERV_NMAX_RQST_ID)


/* Maximum reply size */
static __inline__ size_t
genom_camera_max_reply_size()
{
  size_t m = 0, s;
  ...
  s += genom_maxserialen_t_camera_INVALID_DATA();
  if (m < s) m = s;
...
#define  CAMERA_MAX_REPLY_SIZE		genom_camera_max_reply_size()
#define  CAMERA_MAX_INTERMED_REPLY_SIZE	sizeof(int)

/* Size of reply mbox (clients) */
#define  CAMERA_CLIENT_MBOX_REPLY_SIZE        	\
  ((MBOX_BUF_SIZE(CAMERA_MAX_REPLY_SIZE) +		\
    MBOX_BUF_SIZE(CAMERA_MAX_INTERMED_REPLY_SIZE))	\
   * CLIENT_NMAX_RQST_ID)

#endif /* H_CAMERA_MSGLIB */
