  ...
  char *buffer, int size, char *dst, int maxsize)
{
  ...
  struct genom_camera_abort_activity_input *in =
    (struct genom_camera_abort_activity_input *)buffer;
  ssize_t s;
...
void
genom_camera_client_abort_activity_init_input(
  struct genom_camera_abort_activity_input *in)
{
  ...
  /* set default value */
  genom_camera_client_abort_activity_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_abort_activity_fini_input(
  struct genom_camera_abort_activity_input *in)
{
...
void
genom_camera_client_abort_activity_fini_output(
  struct genom_camera_abort_activity_output *out)
{
  (void)out; /* fix -Wunused-parameter */
}
  ...
  char *buffer, int size, char *dst, int maxsize)
{
  ...
  struct genom_camera_connect_port_input *in =
    (struct genom_camera_connect_port_input *)buffer;
  ssize_t s;
  (void)size; /* fix -Wunused-parameter */
...
void
genom_camera_client_connect_port_init_input(
  struct genom_camera_connect_port_input *in)
{
  ...
  /* set default value */
  genom_camera_client_connect_port_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_connect_port_fini_input(
  struct genom_camera_connect_port_input *in)
{
...
void
genom_camera_client_connect_port_fini_output(
  struct genom_camera_connect_port_output *out)
{
  (void)out; /* fix -Wunused-parameter */
}
  ...
  char *buffer, int size, char *dst, int maxsize)
{
  ...
  struct genom_camera_connect_service_input *in =
    (struct genom_camera_connect_service_input *)buffer;
  ssize_t s;
  (void)size; /* fix -Wunused-parameter */
...
void
genom_camera_client_connect_service_init_input(
  struct genom_camera_connect_service_input *in)
{
  genom_tinit_string128(
    in->local);
  ...
  /* set default value */
  genom_camera_client_connect_service_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_connect_service_fini_input(
  struct genom_camera_connect_service_input *in)
{
  genom_tfini_string128(
    in->local);
...
void
genom_camera_client_connect_service_fini_output(
  struct genom_camera_connect_service_output *out)
{
  (void)out; /* fix -Wunused-parameter */
}
...
void
genom_camera_client_kill_init_input(
  struct genom_camera_kill_input *in)
{

  /* set default value */
  genom_camera_client_kill_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_kill_fini_input(
  struct genom_camera_kill_input *in)
{
...
void
genom_camera_client_kill_fini_output(
  struct genom_camera_kill_output *out)
{
  (void)out; /* fix -Wunused-parameter */
}
...
{
  struct genom_client_request *a = (struct genom_client_request *)dst;
  struct genom_camera_GetCurrentPosition_output *out = a->output;
  ssize_t len = size;
  char *p = buffer;
  int s;
  (void)maxsize; /* fix -Wunused-parameter */
...
void
genom_camera_client_GetCurrentPosition_init_input(
  struct genom_camera_GetCurrentPosition_input *in)
{

  /* set default value */
  genom_camera_client_GetCurrentPosition_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_GetCurrentPosition_fini_input(
  struct genom_camera_GetCurrentPosition_input *in)
{
  (void)in; /* fix -Wunused-parameter */
}
...
void
genom_camera_client_GetCurrentPosition_fini_output(
  struct genom_camera_GetCurrentPosition_output *out)
{
...
{
  struct genom_client_request *a = (struct genom_client_request *)dst;
  struct genom_camera_GetCurrentMap_output *out = a->output;
  ssize_t len = size;
  char *p = buffer;
  int s;
  (void)maxsize; /* fix -Wunused-parameter */
...
void
genom_camera_client_GetCurrentMap_init_input(
  struct genom_camera_GetCurrentMap_input *in)
{

  /* set default value */
  genom_camera_client_GetCurrentMap_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_GetCurrentMap_fini_input(
  struct genom_camera_GetCurrentMap_input *in)
{
  (void)in; /* fix -Wunused-parameter */
}
...
void
genom_camera_client_GetCurrentMap_fini_output(
  struct genom_camera_GetCurrentMap_output *out)
{
...
{
  struct genom_client_request *a = (struct genom_client_request *)dst;
  struct genom_camera_GetCurrentArena_output *out = a->output;
  ssize_t len = size;
  char *p = buffer;
  int s;
  (void)maxsize; /* fix -Wunused-parameter */
...
void
genom_camera_client_GetCurrentArena_init_input(
  struct genom_camera_GetCurrentArena_input *in)
{

  /* set default value */
  genom_camera_client_GetCurrentArena_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_GetCurrentArena_fini_input(
  struct genom_camera_GetCurrentArena_input *in)
{
  (void)in; /* fix -Wunused-parameter */
}
...
void
genom_camera_client_GetCurrentArena_fini_output(
  struct genom_camera_GetCurrentArena_output *out)
{
...
void
genom_camera_client_FilmStop_init_input(
  struct genom_camera_FilmStop_input *in)
{

  /* set default value */
  genom_camera_client_FilmStop_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_FilmStop_fini_input(
  struct genom_camera_FilmStop_input *in)
{
  (void)in; /* fix -Wunused-parameter */
}
...
void
genom_camera_client_FilmStop_fini_output(
  struct genom_camera_FilmStop_output *out)
{
  (void)out; /* fix -Wunused-parameter */
}
  ...
  char *buffer, int size, char *dst, int maxsize)
{
  ...
  if (*p == *"") {
    ...
    a->exfini = (void (*)(void *))genom_tfini_t_genom_mwerr;
    s = genom_deserialize_t_genom_mwerr(&p, &len, a->exdetail);
  } else if (!strcmp(p, camera_INVALID_DATA_id)) {
    assert(a->exdetail == NULL && a->exfini == NULL);
    len -= sizeof(camera_INVALID_DATA_id);
    a->report = camera_INVALID_DATA_id;
  } else if (!strcmp(p, genom_syserr_id)) {
    assert(a->exdetail == NULL && a->exfini == NULL);
    a->exdetail = malloc(sizeof(genom_syserr_detail));
    if (!a->exdetail) {
...
void
genom_camera_client_StartFilm_init_input(
  struct genom_camera_StartFilm_input *in)
{

  /* set default value */
  genom_camera_client_StartFilm_json_scan(in,
                  "{ }",
                  NULL);
}
...
void
genom_camera_client_StartFilm_fini_input(
  struct genom_camera_StartFilm_input *in)
{
  (void)in; /* fix -Wunused-parameter */
}
...
void
genom_camera_client_StartFilm_fini_output(
  struct genom_camera_StartFilm_output *out)
{
  (void)out; /* fix -Wunused-parameter */
}
